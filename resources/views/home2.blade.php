...
<div class="" style="padding-left:50px; padding-right:50px; background:EEEEEE">
    <div class="row">
        <div class="col" style="margin-top:220px">
            ...
            <a href="/order" class="btn btn-success btn-lg" style="margin-top:20px; padding-right:50px; padding-left:50px; background: #85FF00">Service</a>
...
<div class="bg-light" style="padding-left:50px; padding-right:50px">
    <div class="row">
        <div class="col">
            <a class="display-2" style="margin-top:100px; margin-left:50px; font-family:'poppins' sans-serif; font-weight:bold; color:#85FF00;">WHO </a>
            <a class="display-2" style="margin-top:100px; font-family:'poppins' sans-serif; font-weight:bold; color:#000000;">  We Are</a></br>
            <p class="display-5" style="margin-top:10px; margin-left:50px; font-size:30px">Kami merupakan badan usaha yang dikelola oleh mahasiswa teknik elektro UM dan bergerak di bidang elektronika dan informatika khususnya jasa servis laptop dan alat elektronik. Pelayanan yang kami sediakan yaitu Jasa Servis laptop (kerusakan hardware maupun software), Jasa Servis Elektronika, Vendor Lighting, Jasa Pembuatan Vandel dan Gantungan kunci akrilik. </p>
        </div>
        <div class="col" style="margin-top:10px; margin-right:-200px">
  ...
  <div class="row no-gutters">
    ...
    <div class="row">
        <div class="col" style="margin-top:50px; margin-bottom:50px">
            <img src="{{ asset('img/servis-elektronik.jpg') }}" class="image" alt="..." >
        </div>
        <div class="col" style="margin-top:150px">
            <a class="display-4" style="font-family:poppins; color:#85FF00;">Servis</a>
            <a class="display-4" style="font-family:poppins; color:#000000;"> Elektronik</a>
            <h4 style="margin-top:10px; font-family:poppins">Servis Center menyediakan jasa servis alat elektronik seperti laptop, handphone, TV, kipas </h4>
        </div>
    </div>
    <div class="row">
        <div class="col" style="margin-top:150px">
            <a class="display-4" style="font-family:poppins; color:#85FF00;">Vendor</a>
            <a class="display-4" style="font-family:poppins; color:#000000;"> Lighting</a>
            <h4 style="margin-top:10px; font-family:poppins">Servis Center menyediakan jasa servis alat elektronik seperti laptop, handphone, TV, kipas </h4>
        </div>
        <div class="col" style="margin-top:50px; margin-bottom:50px">
            <img src="{{ asset('img/vendor-lighting.jpg') }}" class="image" alt="..." >
        </div>
    </div>
    <div class="row">
        <div class="col" style="margin-top:50px; margin-bottom:50px">
            <img src="{{ asset('img/ganci.jpg') }}" class="image" alt="..." >
        </div>
        <div class="col" style="margin-top:150px">
            <a class="display-4" style="font-family:poppins; color:#85FF00;">Jasa</a>
            <a class="display-4" style="font-family:poppins; color:#000000;"> Pembuatan Vandel dan Ganci</a>
            <h4 style="margin-top:10px; font-family:poppins">Servis Center menyediakan jasa servis alat elektronik seperti laptop, handphone, TV, kipas </h4>
        </div>
    </div>
</div>
...
<footer class="page-footer font-small teal pt-4 bg-dark">
  ...
  <div class="container-fluid text-center text-md-left">
    <div class="row text-light text-center">
        <b class="text-center">SERVICE CENTER UM</b>
